...
const TeamMembers = () => {
  ...
  return (
    <Card className="w-full max-w-full text-sm">
      ...
      <CardContent className="max-w-full overflow-hidden p-4">
          ...
          <div className="space-y-3">
            {teamMembers.map((member) => {
              ...
              return (
                <div
                  key={member.id}
                  className={`flex items-center justify-between p-2 border rounded-lg transition-colors w-full max-w-full ${
                    isCurrentUser 
